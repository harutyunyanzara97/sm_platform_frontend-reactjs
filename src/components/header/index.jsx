...
import { Logo,avatar02,avatar03,avatar05,avatar06,avatar08,avatar09,
      avatar13,avatar17,avatar21,Flag_de,Flag_es,Flag_fr,Flag_us } from '../imagepath';
import {S_Logo} from "../imagepath";
    ...
    return (
      <div className="header" id="heading">
        ...
        <div className="header-left">
          <a className="logo">
            <img src="https://lh3.googleusercontent.com/gJodxlidHJcqpYFm1_YfZKG1gZbmJBm_QH3GuXT8kgHbei9ZLMtJ5JCtY5TtMBV01AoBB-YXa96T_t0tMAfaPLfkZIlsBHGD4N2thNFE" alt="Logo" className="sidebar-logo" />
            <img src="https://lh3.googleusercontent.com/gJodxlidHJcqpYFm1_YfZKG1gZbmJBm_QH3GuXT8kgHbei9ZLMtJ5JCtY5TtMBV01AoBB-YXa96T_t0tMAfaPLfkZIlsBHGD4N2thNFE" alt="Logo" className="mini-sidebar-logo" />
          </a>
        </div>
        {/* /Logo */}
        <a id="toggle_btn">
